...
concurrently --names "BACKEND,FRONTEND" -c "blue,green" "cd Backend && venv20\Scripts\activate && uvicorn app.main:app --host 127.0.0.1 --port 8000" "cd Frontend\derma-ai && npm run dev"
